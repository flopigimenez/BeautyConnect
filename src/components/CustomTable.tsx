    ...
    <div className="lg:p-4 pt-4">
      {title && (
        <div className="md:flex md:justify-between items-center mb-4">
          <h2 className="text-2xl md:text-3xl font-bold font-secondary text-[#703F52] mb-3">{title}</h2>
          {actionButton && (
            <button
          ...
          {busqueda && (
            <input
              ...
              className="border border-gray-300 rounded-full px-2 py-1 ml-3 md:px-4 md:py-2 md:w-[40%] focus:outline-none focus:ring-2 focus:ring-[#C19BA8]"
            />
          )}
        </div>
      )}
