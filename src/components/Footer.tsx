  ...
  return (
    <footer className="bg-[#e9d9de] text-[#3c2e35] pt-5 border-t border-[#e9dde1] shadow-inner">  {/*gradient-to-t from-secondary to-*/}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-2 mt-2 md:mt-0 mr-10">
          ...
          <span className="text-xs text-[#7F3C56] font-secondary ml-10">Conectando belleza y bienestar</span>
        </div>
